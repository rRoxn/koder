...
class petowner:
        ...
        while True:
            try:
                ...
                if 1 <= val <= len(self.__djur):
                    ...
                    if djur._hungry:
                        print(f"Djuret {djur._name} är för hungrig för att leka")
                    else:
    ...
    def feed(self):
        """
        Allows the user to choose an animal and feed it.
        The eating loop is handled within the Animal.eat() method.
        """
        ...
        try:
            ...
            if 1 <= val <= len(self.__djur):
                ...
                djur.eat(food)  # Call the eat() method of the animal
            else:
                print("Ogiltigt val.")
        except ValueError:
            print("Ogiltigt val.")

    # Funktion för meny efter de 5 första objekten skapas. För att integrera med i__djur
    def run(self):
        print("Sötnosarna")
